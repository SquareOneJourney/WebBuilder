    ...
    >
      ...
      <div
        className={cn(
          ...
          "group-data-[collapsible=offcanvas]:left-0 group-data-[collapsible=offcanvas]:w-0",
          "group-data-[side=right]:right-0 group-data-[side=left]:left-0",
          variant === "floating" || variant === "inset"
            ? "group-data-[collapsible=icon]:left-2 group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)_+_theme(spacing.4))]"
            : "group-data-[collapsible=icon]:left-0 group-data-[collapsible=icon]:w-[--sidebar-width-icon]",
          className
        )}
        {...props}
      >
        <div
          data-sidebar="sidebar"
          className="flex h-full w-full flex-col bg-sidebar group-data-[variant=floating]:border-r-sidebar-border group-data-[variant=floating]:bg-sidebar group-data-[variant=inset]:border-r-sidebar-border"
        >
          {children}
        </div>
      </div>
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "group-data-[collapsible=offcanvas]:translate-x-0 group-data-[collapsible=offcanvas]:after:left-full group-data-[collapsible=offcanvas]:hover:after:bg-sidebar-border",
        className
      )}
      {...props}
    />
